...
describe('corrupt knowledge files', () => {
    ...
    beforeAll(async () => {
        ...
        await fs.writeFile(path.join(corruptDir, 'index.json'), JSON.stringify({ lastBuilt: '2024-01-01T00:00:00Z', fileCount: 0, hasSymbols: true, hasDependencies: true }), 'utf8');
    });
...
describe('empty results', () => {
    ...
    beforeAll(async () => {
        ...
        await fs.writeFile(path.join(emptyDir, 'index.json'), JSON.stringify({ lastBuilt: '2024-01-01T00:00:00Z', fileCount: 0, hasSymbols: true, hasDependencies: true }), 'utf8');
