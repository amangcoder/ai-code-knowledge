...
import type { CallToolResult, FeatureGroup, GetFeatureContextArgs } from '../types.js';
            ...
            return {
                content: [{
                    ...
                    text: [
                        ...
                        '',
                        'Default provider is HuggingFace (CodeSage). Set EMBEDDING_MODEL=ollama for local Ollama, or EMBEDDING_MODEL=openai with OPENAI_API_KEY.',
                    ].join('\n'),
                }],
                isError: true,
            };
