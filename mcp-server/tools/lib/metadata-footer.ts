...
import type { Section } from './response-budget.js';
 ...
 * @param projectRoot Absolute project root path
 */
export function buildFooter(index: KnowledgeIndex, projectRoot: string): string {
 ...
 * @param projectRoot Absolute project root path
 */
export function buildFooterSection(index: KnowledgeIndex, projectRoot: string): Section {
    return {
        label: '',
