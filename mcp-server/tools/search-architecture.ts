...
interface SearchResult {
  source: 'architecture-doc' | 'file-summary' | 'symbol-jsdoc';
  label: string;
  snippet: string;
}
...
function searchArchitectureDoc(
